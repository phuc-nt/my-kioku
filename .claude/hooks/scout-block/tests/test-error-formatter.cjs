...
test('formatConfigPath with claudeDir', formatConfigPath('/home/user/.claude').includes('.mkignore'));
test('formatConfigPath prefers explicit configPath', formatConfigPath('/home/user/.claude', '/tmp/project/.mkignore') === '/tmp/project/.mkignore');
test('formatConfigPath without claudeDir', formatConfigPath(null) === '.claude/.mkignore');
test('formatConfigPath empty string', formatConfigPath('') === '.claude/.mkignore');
...
const blockError = formatBlockedError({
  ...
  configPath: '/home/user/project/.mkignore'
});
...
test('formatBlockedError prefers explicit config path', blockError.includes('/home/user/project/.mkignore'));
...
const machineError = formatMachineError({
  ...
  tool: 'Read',
  claudeDir: '.claude',
  configPath: '/tmp/project/.mkignore'
});
...
test('formatMachineError has config field', parsed.config === '/tmp/project/.mkignore');
