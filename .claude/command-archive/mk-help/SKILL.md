---
name: mk:mk-help
description: "MyKit usage guide — discover commands, skills, workflows naturally."
...
All-in-one MyKit guide. Run the script and present output based on type markers.
...
The script outputs a type marker on the first line: `@MK_OUTPUT_TYPE:<type>`

**Read this marker and adjust your presentation accordingly:**

### `@MK_OUTPUT_TYPE:comprehensive-docs`
...
### `@MK_OUTPUT_TYPE:command-details`
...
### `@MK_OUTPUT_TYPE:task-recommendations`
