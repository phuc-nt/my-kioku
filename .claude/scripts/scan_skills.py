...
def write_catalog_yaml(skills: list[dict], repo_root: Path) -> Path:
    ...
    lines = [
        ...
        f"  description: {_qs('Auto-generated catalog of all available skills in MyKit Engineer')}",
...
def write_catalog_markdown(skills: list[dict], repo_root: Path) -> Path:
    ...
    lines = [
        "# Skills Catalog", "",
        "Auto-generated catalog of all available skills in MyKit Engineer.", "",
