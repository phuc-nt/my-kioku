...
1. **Screenshots provided** → Use `mk:ai-multimodal` skill for detailed context analysis
2. **Videos provided** → Use `mk:ai-multimodal` video-analysis for comprehensive context
