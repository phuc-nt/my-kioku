...
Activate the mk:chrome-devtools skill.
...
## Workflow
- Use `mk:plan` skill to organize the test plan & report
...
- Use `mk:ai-multimodal` to analyze all screenshots
- Generate comprehensive Markdown report
- Ask user if they want to preview with `/mk:preview`
