...
- Otherwise use `mk:repomix` to generate fresh codebase summary
- Use `/mk:scout` or `/mk:scout ext` to find relevant files
- Use `mk:docs-seeker` skill for package/plugin documentation
