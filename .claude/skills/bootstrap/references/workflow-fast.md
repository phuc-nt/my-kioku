...
2. If no logo provided: generate with `mk:ai-multimodal` skill
3. Screenshot wireframes with `mk:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **mk:plan** skill: `/mk:plan --fast <requirements>`
