...
3. If no logo provided: generate with `mk:ai-multimodal` skill
4. Screenshot wireframes with `mk:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **mk:plan** skill: `/mk:plan --auto <requirements>`
...
Activate **mk:cook** skill: `/mk:cook --auto <plan-path>`
