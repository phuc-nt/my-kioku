...
## Prerequisites
- Activate `mk:ui-ux-pro-max` skill first for design intelligence
- Have `mk:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `mk:ai-multimodal` skill to extract:
...
### 4. Generate Assets
Use `mk:ai-multimodal` skill:
- Generate images, icons, backgrounds
- Verify generated assets match design
- Remove backgrounds if needed with `mk:media-processing`
