...
## Prerequisites
- Activate `mk:ui-ux-pro-max` skill first
- Activate `mk:threejs` skill for 3D and WebGL expertise
- Have `mk:ai-multimodal` skill ready for asset generation

## Initial Research
Run `mk:ui-ux-pro-max` searches:
```bash
...
Use `mk:ai-multimodal` skill for:
- Textures and materials
- Skyboxes and environment maps
- Particle sprites
- Video backgrounds

Use `mk:media-processing` skill for:
